...
<html lang="en">
  <head>
    ...
    <script>
      ...
      // when hitting enter to sign in, click the button for them
      ...
      function check_e_username() {
        ...
        if ($('#e_username').val() == "") {
          ...
          if (typeof current_username === 'undefined') {
            ...
            $.ajax({ 
              ...
              success: function (data) { 
                if (data['user_exists'] == "true") {
                  ...
                  // warn - username taken
                  $("#e_username_exists_warning").show();

                } else {

                  // user does not exist
                  $("#e_username_exists_warning").hide();
            ...
            if ($('#e_username').val() == current_username){
              // do nothing
            } else {
      ...
      // check existing member radio button
  ...
  <body>
    ...
    <div class="container"> <!-- container -->
      ...
      <h1>2017 No-Shave November Registration</h1>
      <hr>
      ...
      <div class="row"> <!-- row -->
        <div class="col-lg-8 col-lg-offset-2"> <!-- col-lg-8 col-lg-offset-2 -->
          <div class="tab-content"> <!-- tab-content -->
            ...
            <!-- Seciont 1 - Did you participate in No-Shave November last year? -->
            <div id="section_1" class="tab-pane fade in active"> <!-- section_1 -->

              <h2 class="centered">Did you participate in No-Shave November last year?</h2>
              <p class="centered">If you signed up to participate last year we can retrieve your account.</p>
              <br>

              <div class="centered">
                <div class="centered btn-table" data-toggle="buttons">
                  <label class="btn btn-default btn-checkbox">
                    <input type="radio" name="existing_member" id="no" value="no" checked> <i class="fa fa-child fa-5x" aria-hidden="true"></i><br><br>New
                  </label>
                  <!-- Need some room, geeze -->
                  &nbsp;&nbsp;&nbsp;&nbsp;
                  <label class="btn btn-default btn-checkbox">
                    <input type="radio" name="existing_member" id="yes" value="yes"> <i class="fa fa-repeat fa-5x" aria-hidden="true"></i><br><br>Returning
                  </label>
                </div>
              </div>
            ...
            <!-- Seciont 2 - Please enter your login information. -->
            <div id="section_2" class="tab-pane fade in"> <!-- section_2 -->

              <h2 class="centered">Please enter your login information.</h2>
              <p class="centered">Welcome back! Please sign in so that we can pull up your account information.</p>

              <form class="form-horizontal"> <!-- form -->
                <div class="form-group">
                  <label for="email_login" class="col-md-3 control-label">Email address <span class="required-field">*</span></label>

                  <div class="col-md-7">
                    <input type="email" class="form-control full-input-width" name="email_login" id="email_login" placeholder="Email Address" required>
                  </div>
                </div>
                <div class="form-group">
                  <label for="password_login" class="col-md-3 control-label">Password <span class="required-field">*</span></label>

                  <div class="col-md-7">
                    <input type="password" class="form-control full-input-width" name="password_login" id="password_login" placeholder="Password" required>
                  </div>
                </div>
              ...
              <br><br>
              <button name="section_2_back" id="section_2_back" type="button" class="btn btn-default pull-left" data-toggle="tab" href="#section_1"><i class="fa fa-arrow-left" aria-hidden="true"></i> Go Back</button>
              <button href="#" name="sign_in" id="sign_in" type="button" class="btn btn-primary pull-right" onclick="sign_in()">Sign In <i class="fa fa-sign-in" aria-hidden="true"></i></button>
              <button name="section_2_continue" id="section_2_continue" type="button" class="btn btn-success pull-right" data-toggle="tab" href="#section_3">Continue <i class="fa fa-arrow-right" aria-hidden="true"></i></button>

            </div> <!-- section_2 -->
            <!-- Seciont 2 - Please enter your login information. -->       

            <!-- Seciont 3 - Please review and update your information. -->
            <div id="section_3" class="tab-pane fade in"> <!-- section_3 -->

              <h2 class="centered">Please review and update your information.</h2>
              <p class="centered">Make sure to fill in all the fields as clearly and accurately as possible.</p>

              <form class="form-horizontal"> <!-- form -->

                <div class="form-group">
                  <label for="e_full_name" class="col-md-3 control-label">Full Name <span class="required-field">*</span></label>

                  <div class="col-md-7">
                    <input type="text" class="form-control full-input-width" name="e_full_name" id="e_full_name" placeholder="Full Name" maxlength="128" pattern=".*\s.*" data-error="Please enter your full name." required>
                  </div>
                </div>

                <div class="form-group">
                  <label for="e_email_address" class="col-md-3 control-label">Email address <span class="required-field">*</span></label>

                  <div class="col-md-7">
                    <input type="email" class="form-control full-input-width" name="e_email_address" id="e_email_address" placeholder="Email Address" data-error="Please enter a valid email address." maxlength="128" required>
                  </div>
                </div>
                ...
                <div class="form-group">
                  <label for="e_username" class="col-md-3 control-label">Username <span class="required-field">*</span></label>

                  <div class="col-md-7">
                    <input type="text" class="form-control full-input-width" name="e_username" id="e_username" placeholder="Username" onkeyup="check_e_username()" placeholder="Please enter a username." pattern="^([_A-z0-9]){1,}$" maxlength="128" required>
                  </div>
                </div>

                <div class="form-group">
                  <label for="e_city" class="col-md-3 control-label">City <span class="required-field">*</span></label>

                  <div class="col-md-7">
                    <input type="text" class="form-control full-input-width" name="e_city" id="e_city" placeholder="City" placeholder="Please enter your city." maxlength="64" required>
                  </div>
                </div>

                <div class="form-group">
                  <label for="e_state" class="col-md-3 control-label">State / Region</label>

                  <div class="col-md-7">
                    <input type="text" class="form-control full-input-width" name="e_state" id="e_state" placeholder="Please enter your State / Region." maxlength="64" placeholder="State">
                  </div>
                </div>

                <div class="form-group">
                  <label for="e_country" class="col-md-3 control-label">Country <span class="required-field">*</span></label>

                  <div class="col-md-7">
                    <input type="text" class="form-control full-input-width" name="e_country" id="e_country" placeholder="Country" placeholder="Please enter your Country." maxlength="64" required>
                  </div>
                </div>
              ...
              <br><br>
              <button name="section_3_back" id="section_3_back" type="button" class="btn btn-default pull-left" data-toggle="tab" href="#section_2"><i class="fa fa-arrow-left" aria-hidden="true"></i> Go Back</button>
              <button href="#" name="section_3_submit" id="section_3_submit" type="button" class="btn btn-success pull-right" onclick="old_register()">Submit <i class="fa fa-paper-plane-o" aria-hidden="true"></i></button>
              <button name="section_3_continue" id="section_3_continue"  type="button" class="btn btn-success pull-right" data-toggle="tab" href="#section_17" onclick="old_member()">Continue <i class="fa fa-arrow-right" aria-hidden="true"></i></button>              

            </div> <!-- section_3 -->
            <!-- Seciont 3 - Please review and update your information. -->

            <!-- Seciont 4 - Please enter your information. -->
            <div id="section_4" class="tab-pane fade in"> <!-- section_4 -->

              <h2 class="centered">Please enter your information.</h2>
              <p class="centered">Make sure to fill in all the fields as clearly and accurately as possible.</p>

              <form class="form-horizontal"> <!-- form -->

                <div class="form-group">
                  <label for="n_full_name" class="col-md-3 control-label">Full Name <span class="required-field">*</span></label>

                  <div class="col-md-7">
                    <input type="text" class="form-control full-input-width" name="n_full_name" id="n_full_name" placeholder="Full Name" maxlength="128" pattern=".*\ .*" data-error="Please enter your full name." required>
                  </div>
                </div>

                <div class="form-group">
                  <label for="n_email_address" class="col-md-3 control-label">Email address <span class="required-field">*</span></label>

                  <div class="col-md-7">
                    <input type="email" class="form-control full-input-width" name="n_email_address" id="n_email_address" placeholder="Email Address" data-error="Please enter a valid email address." maxlength="128" required>
                  </div>
                </div>

                <div class="form-group">
                  <label for="n_password" class="col-md-3 control-label">Password <span class="required-field">*</span></label>

                  <div class="col-md-7">
                    <input type="password" class="form-control full-input-width" name="n_password" id="n_password" placeholder="Password" placeholder="Enter a password greater than six characters." minlength="6" required>
                  </div>
                </div>

                <div class="form-group">
                  <label for="n_password_verify" class="col-md-3 control-label">Verify Password <span class="required-field">*</span></label>

                  <div class="col-md-7">
                    <input type="password" class="form-control full-input-width" name="n_password_verify" id="n_password_verify" placeholder="Verify Password" data-match="#n_password" data-match-error="Uh oh, this doesn't match the password above." required>
                  </div>
                </div>
                ...
                <div class="form-group">
                  <label for="n_username" class="col-md-3 control-label">Username <span class="required-field">*</span></label>

                  <div class="col-md-7">
                    <input type="text" class="form-control full-input-width" name="n_username" id="n_username" placeholder="Username" onkeyup="check_n_username()" pattern="^([_A-z0-9]){1,}$" maxlength="128" required>
                  </div>
                </div>

                <div class="form-group">
                  <label for="n_city" class="col-md-3 control-label">City <span class="required-field">*</span></label>

                  <div class="col-md-7">
                    <input type="text" class="form-control full-input-width" name="n_city" id="n_city" placeholder="City" placeholder="Please enter your city." maxlength="64" required>
                  </div>
                </div>

                <div class="form-group">
                  <label for="n_state" class="col-md-3 control-label">State / Region</label>

                  <div class="col-md-7">
                    <input type="text" class="form-control full-input-width" name="n_state" id="n_state" placeholder="State" placeholder="Please enter your State / Region." maxlength="64">
                  </div>
                </div>

                <div class="form-group">
                  <label for="n_country" class="col-md-3 control-label">Country <span class="required-field">*</span></label>

                  <div class="col-md-7">
                    <input type="text" class="form-control full-input-width" name="n_country" id="n_country" placeholder="Country" placeholder="Please enter your Country." maxlength="64" required>
                  </div>
                </div>
              ...
              <br><br>
              <button name="section_4_back" id="section_4_back" type="button" class="btn btn-default pull-left" data-toggle="tab" href="#section_3"><i class="fa fa-arrow-left" aria-hidden="true"></i> Go Back</button>
              <button href="#" name="section_4_submit" id="section_4_submit"  type="button" class="btn btn-success pull-right" onclick="new_register()">Submit <i class="fa fa-paper-plane-o" aria-hidden="true"></i></button>
              <button name="section_4_continue" id="section_4_continue"  type="button" class="btn btn-success pull-right" data-toggle="tab" href="#section_17" onclick="new_member()">Continue <i class="fa fa-arrow-right" aria-hidden="true"></i></button>

            </div> <!-- section_4 -->
            <!-- Seciont 4 - Please enter your information. -->


            <!-- Seciont 17 - Make a Donation -->
            <div id="section_17" class="tab-pane fade in"> <!-- section_17 -->
              <h2 class="centered">Make a Donation</h2>
              <p class="centered">No-Shave November and its funded programs are putting your donation dollars to work, investing in groundbreaking cancer research and providing free information and services to cancer patients and their caregivers.</p>

              <form id="donation_form" class="form-horizontal">
                <div class="form-group">
                  <label for="donation_amount" class="col-md-3 control-label">Amount <span class="required-field">*</span></label>
                  <div class="col-md-9">
                    <label class="radio-inline">
                      <input type="radio" name="donation_amount" id="donation_amount_25" value="25"> $25
                    </label>
                    <label class="radio-inline">
                      <input type="radio" name="donation_amount" id="donation_amount_50" value="50" checked> $50
                    </label>
                    <label class="radio-inline">
                      <input type="radio" name="donation_amount" id="donation_amount_100" value="100"> $100
                    </label>
                    <label class="radio-inline">
                ...
                <div class="form-group">
                  <label for="donation_name" class="col-md-3 control-label">Name <span class="required-field">*</span></label>

                  <div class="col-md-7">
                    <input type="text" class="form-control full-input-width" id="donation_name" placeholder="Name">
                  </div>
                </div>
                ...
                <div class="form-group">
                  ...
                  <div class="col-md-7">
                    <input type="text" class="form-control full-input-width" id="donation_company" placeholder="Company">
                  </div>
                </div>
                ...
                <div class="form-group">
                  ...
                  <div class="col-md-7">
                    <textarea type="text" class="form-control full-input-width" id="donation_comment" placeholder="Comment" rows="3"></textarea>
                  </div>
                </div>
                ...
                <br><br>
                <button name="section_17_back" id="section_17_back" type="button" class="btn btn-default pull-left" data-toggle="tab" href="#section_"><i class="fa fa-arrow-left" aria-hidden="true"></i> Go Back</button>
                <button name="section_17_continue" id="section_17_continue"  type="button" class="btn btn-success pull-right hidden" data-toggle="tab" href="#section_18">Continue <i class="fa fa-arrow-right" aria-hidden="true"></i></button>
                <button href="#" id="make_donation" name="make_donation" type="submit" class="btn btn-success pull-right" onclick="waitForNonce()">Donate $50</button><br>
              </form>
              <br>
              <a id="section_17_skip" class="pull-right" data-toggle="tab" href="#section_18"><i>skip</i></a><br>
            </div> <!-- section_17 -->
            <!-- Seciont 17 - Make a Donation -->

            <!-- Seciont 18 - Complete Registration -->
            <div id="section_18" class="tab-pane fade in"> <!-- section_18 -->

              <h2 class="centered">Complete Registration</h2>
              <p class="centered">Good luck and Hairy November!</p>

              <div class="form-group">
                  <label class="col-xs-3 control-label">Terms of Service</label>
                  <div class="col-xs-9">
              ...
              <br><br><br>
              <button name="section_18_back" id="section_18_back" type="button" class="btn btn-default pull-left" data-toggle="tab" href="#section_17"><i class="fa fa-arrow-left" aria-hidden="true"></i> Go Back</button>
              <a name="section_18_continue" id="section_18_continue" type="button" class="btn btn-success pull-right disabled" href="/login?new=true" onclick="unbindUnload()">Complete Registration &nbsp;<i class="fa fa-check" aria-hidden="true"></i></a>              
            </div> <!-- section_18 -->
            <!-- Seciont 18 - Complete Registration -->
