              ...
              <div class="row">
                  <div class="col-lg-3 col-md-4 col-12 white-bg shadow">
                      <div class="b-sidebar py-4">
                          ...
                          <p>
                              <a href="<?php echo base_url; ?>/donate?id=<?php echo $o_id; ?>&amp;c=3" class="btn btn-primary btn-block btn-sm"><i class="fa fa-heart" aria-hidden="true"></i>&nbsp; Make a Donation</a>
                              ...
                              <a href="Javascript:void(0);" class="btn btn-success btn-block btn-sm" data-toggle="modal" data-target="#shareOrg"><i class="fa fa-share" aria-hidden="true"></i>&nbsp; Share this Page</a>
                          </p>
